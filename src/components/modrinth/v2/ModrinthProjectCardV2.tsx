...
export interface ModrinthProjectCardV2Props
  ...
  isBlocked?: boolean; // Deprecated, use projectDoofieStatus instead
  projectDoofieStatus?: 'blocked' | 'warning' | null;
  projectVersions: UnifiedVersion[] | null | "loading";
  displayedCount: number;
  versionDropdownUIState: {
    showAllGameVersions: boolean;
  ...
  ({
    ...
    return (
      <div>
        ...
        <div
          ...
          installStatus?.is_installed &&
            !installStatus?.is_included_in_doofie_pack &&
            "border-l-green-500",
          !installStatus?.is_installed &&
            installStatus?.is_included_in_doofie_pack &&
            "border-l-blue-500",
      ...
      >
        ...
        {projectDoofieStatus === 'blocked' && (
          <div className="absolute top-2 left-2 z-10 pointer-events-auto">
            <Tooltip content="This mod is blocked by Doofie Client as it is known to cause crashes or severe compatibility issues. Installation is not recommended.">
              <div>
                <Icon 
        ...
        {projectDoofieStatus === 'warning' && (
          <div className="absolute top-2 left-2 z-10 pointer-events-auto">
            <Tooltip content="This version is known to cause crashes or compatibility issues with Doofie Client. Installation is possible but not recommended.">
              <div>
                <Icon 
                  icon="solar:danger-triangle-bold" 
            ...
            {installStatus && (
              <>
                ...
                {installStatus.is_included_in_doofie_pack && (
                  <TagBadge
                    variant={
                      installStatus.doofie_pack_item_details?.is_enabled === false
                        ? "inactive"
                        : "info"
                    }
                    size="sm"
          ...
          {hit.project_type === "modpack" ? (
            ...
            <ActionButton
              ...
              icon={
                isQuickInstalling 
                  ? "solar:refresh-bold" 
                  : (projectDoofieStatus === 'blocked' || projectDoofieStatus === 'warning')
          ...
          projectVersions.length > 0 && (
            <div className="mt-4">
              ...
              onDeleteClick={onDeleteVersionClick}
                ...
                projectDoofieStatus={projectDoofieStatus || (isBlocked ? 'blocked' : null)}
              />
            </div>
          )}
      </div>
