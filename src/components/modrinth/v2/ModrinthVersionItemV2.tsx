...
export const ModrinthVersionItemV2 = React.memo<ModrinthVersionItemV2Props>(
  ({
    ...
    const handleToggleEnableButtonClick = () => {
      if (versionStatus?.doofie_pack_item_details?.doofie_mod_identifier) {
    ...
    if (project.project_type === "modpack" && isInstallingModpackVersion) {
      ...
      if (versionStatus?.is_included_in_doofie_pack && !isModpack) {
    ...
    const showInstallBorder =
      selectedProfileId &&
      (versionStatus?.is_installed ||
        versionStatus?.is_included_in_doofie_pack);
              ...
              <div className="flex gap-1 flex-shrink-0">
                ...
                {selectedProfileId &&
                  ((versionStatus?.is_installed &&
                    ...
                    onToggleEnableClick) ||
                    (versionStatus?.is_included_in_doofie_pack &&
                      versionStatus?.doofie_pack_item_details &&
                      onToggleEnableClick)) && (
                    <ActionButton
