...
type MainTabType = "content" | "browse" | "worlds" | "logs" | "screenshots" | "modsv2" | "resourcepacksv2" | "doofiev2" | "datapacksv2" | "shaderpacksv2";
type ContentSubType =
  | "modsv2"
  | "resourcepacksv2"
  | "shaderpacksv2"
...
export function ProfileDetailView({
  ...
  const contentSubTabs = [
    ...
    {
      id: "doofiev2" as ContentSubType,
      label: t('profiles.content.doofieMods'),
            ...
            {activeMainTab === "content" && (
              <>
                ...
                {activeContentType === "datapacksv2" && (
                  ...
                  {activeContentType === "doofiev2" && (
                  <LocalContentTabV2<LocalContentItem>
                    profile={currentProfile}
                    contentType="DoofieMod"
                    getDisplayFileName={getGenericDisplayFileName}
                    itemTypeName={t('profiles.content.doofieMod')}
                    itemTypeNamePlural={t('profiles.content.doofieMods')}
