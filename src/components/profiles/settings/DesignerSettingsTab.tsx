...
export function DesignerSettingsTab({
  ...
  const handleKeepLocalAssetsChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    updateProfile({
      doofie_information: {
        ...(editedProfile.doofie_information || { 
          is_experimental: editedProfile.doofie_information?.is_experimental || false 
        }), 
        ...
        <div className="p-0">
          <div className="flex items-center space-x-3 mb-2">
            <Checkbox
              ...
              checked={
                editedProfile.doofie_information?.keep_local_assets || false
              }
