...
export function NRCTab({
  ...
  const selectedPackId = editedProfile.selected_doofie_pack_id || "";
  ...
  useEffect(() => {
    const checkPackCompatibility = async () => {
      if (!editedProfile.selected_doofie_pack_id || editedProfile.selected_doofie_pack_id === "") {
      ...
      try {
        ...
        // Check if the selected pack has Doofie Client mods
        if (!resolvedPacks.packs[editedProfile.selected_doofie_pack_id]) {
  ...
  }, [editedProfile.selected_doofie_pack_id]);
        ...
        <div className="space-y-3">
          ...
          {loading ? (
            ...
            <>
              <div className="flex gap-3 items-end">
                <div className="flex-1">
                  <CustomDropdown
                    ...
                    value={editedProfile.selected_doofie_pack_id || ""}
                    onChange={(value) =>
                      updateProfile({
                        selected_doofie_pack_id: value === "" ? null : value,
                      })
                    }
                    options={[{ value: "", label: t('nrc.none_optional') }, ...doofiePackOptions]}
                    variant="search"
                    className=""
                  />
                </div>
              ...
              {showYellowWarning ? (
              ...
              ) : editedProfile.selected_doofie_pack_id === null || editedProfile.selected_doofie_pack_id === "" ? (
                <div className="text-center">
                ...
                editedProfile.selected_doofie_pack_id && doofiePacks[editedProfile.selected_doofie_pack_id] && (
                  <div className="text-center">
                    <p className="text-sm text-white/70 font-minecraft-ten">
                      {doofiePacks[editedProfile.selected_doofie_pack_id].description}
                    </p>
                  </div>
                )
              )}
