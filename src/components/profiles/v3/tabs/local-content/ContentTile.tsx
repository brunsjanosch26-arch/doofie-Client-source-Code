...
export interface ContentTileProps {
  ...
  // Doofie Compatibility-Status (null wenn Config nicht geladen oder ok)
...
export function ContentTile({
  ...
  return (
    ...
    >
      ...
      {/* Icon + optionales Doofie-Warn-Icon */}
      <div className="relative w-14 h-14 flex-shrink-0">
        ...
        {noRiskStatus === "blocked" && (
          <div className="absolute top-0.5 left-0.5 z-10">
            <Tooltip content={t("profiles.v3.tile.doofieBlocked")}>
        ...
        {noRiskStatus === "warning" && (
          <div className="absolute top-0.5 left-0.5 z-10">
            <Tooltip content={t("profiles.v3.tile.doofieWarning")}>
