...
import { NRCTab } from "./settings/DoofieTab";
  ...
  const handleSave = async () => {
    try {
      ...
      await updateProfile(profile.id, {
        ...
        selected_doofie_pack_id: editedProfile.selected_doofie_pack_id,
        clear_selected_doofie_pack: !editedProfile.selected_doofie_pack_id,
        group: editedProfile.group,
        clear_group: !editedProfile.group,
        description: editedProfile.description,
        doofie_information: editedProfile.doofie_information,
