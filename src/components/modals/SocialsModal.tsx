      ...
      const init = async () => {
        try {
          ...
          if (config.is_experimental) {
            ...
            setReferralLink(
              `https://api-staging.doofie.gg/api/v1/launcher/referral/download?code=${activeAccount.username}&beta=${betaFlag}`
            );
          } else {
        ...
        <div className="space-y-2">
          ...
          <AccountLinkRow
            icon="ic:baseline-discord"
              ...
              visitUrl="https://discord.doofie.gg"
            />
          ...
          <AccountLinkRow
            ...
            visitUrl="https://github.com/DoofieClient"
          />
        </div>
      </div>
    </Modal>
