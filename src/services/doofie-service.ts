...
export const refreshNoriskPacks = (): Promise<void> => {
  return invoke('refresh_doofie_packs');
};
...
export const refreshNrcDataOnMount = async (): Promise<void> => {
  ...
  try {
    ...
    // Fire and forget: Refresh user permissions from Doofie backend
    refreshPermissions()
...
/**
 * Gets the mobile app token for Doofie mobile app linking.
 *
...
/**
 * Resets the mobile app token for Doofie mobile app linking.
 *
