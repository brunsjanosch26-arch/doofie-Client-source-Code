...
import { NoriskVersionsConfig } from "../types/doofieVersions";
...
export async function installProfile(id: string): Promise<void> {
  return invoke<void>("repair_profile", { id });
}
...
export async function setNoriskModStatus(
  ...
  return invoke<void>("set_doofie_mod_status", {
    profileId,
    packId,
    modId,
    gameVersion,
...
export async function getNoriskPacks(): Promise<any> {
  return invoke<any>("get_doofie_packs");
}

export async function getNoriskPacksResolved(): Promise<any> {
  return invoke<any>("get_doofie_packs_resolved");
}
...
export async function refreshNoriskPacks(): Promise<void> {
  return invoke<void>("refresh_doofie_packs");
}
