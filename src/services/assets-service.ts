 ...
 * 
 * @param url - The CDN URL of the asset model (e.g., "https://cdn.doofie.gg/asset-models/cosmetics/hat/amethyst_halo/amethyst_halo.gltf")
 ...
 * @example
 * ```typescript
 * const assetUrl = await getOrDownloadAssetModel('https://cdn.doofie.gg/asset-models/cosmetics/hat/amethyst_halo/amethyst_halo.gltf');
