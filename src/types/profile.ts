...
export interface Profile {
  ...
  state: ProfileState;
  mods: Mod[];
  selected_doofie_pack_id: string | null;
  disabled_doofie_mods_detailed: NoriskModIdentifier[];
  ...
  doofie_information: NoriskInformation | null;
...
export interface CreateProfileParams {
  ...
  selected_doofie_pack_id?: string;
  use_shared_minecraft_folder?: boolean;
}
...
export interface UpdateProfileParams {
  ...
  use_shared_minecraft_folder?: boolean;
  description?: string | null;
  clear_selected_doofie_pack?: boolean;
  banner?: ProfileBanner | null;
  background?: ProfileBanner | null;
  doofie_information?: NoriskInformation | null;
  preferred_account_id?: string | null;
...
/**
 * Details about an item when it comes from a Doofie Pack
 */
export interface DoofiePackItemDetails {
  is_enabled: boolean;
  doofie_mod_identifier?: NoriskModIdentifier;
}

export interface ContentInstallStatus {
  is_included_in_doofie_pack: boolean;
  is_installed: boolean;
  is_specific_version_in_pack: boolean;
  is_enabled?: boolean;
  found_item_details?: FoundItemDetails;
  doofie_pack_item_details?: DoofiePackItemDetails;
}
...
export interface LocalContentItem {
  ...
  doofie_info?: NoriskModIdentifier | null; // Identifier for DoofieMods
