...
export interface SimpleTextNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.SimpleTextNotification";
  message: string;
}
...
export interface FriendRequestReceivedNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.FriendRequestReceivedNotifications";
...
export interface FriendRequestAcceptedNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.FriendRequestAcceptedNotifications";
  friend: NotificationUser;
}
...
export interface ShopGiftReceivedNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.ShopGiftReceivedNotification";
...
export interface ShopItemBoughtNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.ShopItemBoughtNotification";
  shopItem: NotificationShopItem;
  expirationDate: string | null;
}
...
export interface ShopItemExpiringSoonNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.ShopItemExpiringSoonNotification";
  shopItem: NotificationShopItem;
...
export interface ShopItemExpiredNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.ShopItemExpiredNotification";
  shopItem: NotificationShopItem;
}
...
export interface McRealPunishmentNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.McRealPunishmentNotification";
  duration: string;
  reason: string;
  expirationDate: string | null;
}
...
export interface McRealPunishmentRevokedNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.McRealPunishmentRevokedNotification";
}
...
export interface McRealPostCommentedNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.McRealPostCommentedNotification";
  postId: string;
  commentId: string;
  commenter: string;
...
export interface McRealCommentCommentedNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.McRealCommentCommentedNotification";
...
export interface McRealPostedNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.McRealPostedNotification";
  postId: string;
  author: string;
...
export interface McRealMentionedInPostNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.McRealMentionedInPostNotification";
  postId: string;
  author: string;
  authorInfo?: NotificationUser;
}
...
export interface McRealMentionedInCommentNotification extends NotificationBase {
  type: "gg.doofie.networking.model.notifications.notification.McRealMentionedInCommentNotification";
  commentId: string;
  author: string;
  authorInfo?: NotificationUser;
  commentPreview?: string;
...
const TYPES = {
  SIMPLE_TEXT: "gg.doofie.networking.model.notifications.notification.SimpleTextNotification",
  STRING: "string",
  FRIEND_REQUEST_RECEIVED: "gg.doofie.networking.model.notifications.notification.FriendRequestReceivedNotifications",
  FRIEND_REQUEST_ACCEPTED: "gg.doofie.networking.model.notifications.notification.FriendRequestAcceptedNotifications",
  SHOP_GIFT_RECEIVED: "gg.doofie.networking.model.notifications.notification.ShopGiftReceivedNotification",
  SHOP_ITEM_BOUGHT: "gg.doofie.networking.model.notifications.notification.ShopItemBoughtNotification",
  SHOP_ITEM_EXPIRING_SOON: "gg.doofie.networking.model.notifications.notification.ShopItemExpiringSoonNotification",
  SHOP_ITEM_EXPIRED: "gg.doofie.networking.model.notifications.notification.ShopItemExpiredNotification",
  MCREAL_PUNISHMENT: "gg.doofie.networking.model.notifications.notification.McRealPunishmentNotification",
  MCREAL_PUNISHMENT_REVOKED: "gg.doofie.networking.model.notifications.notification.McRealPunishmentRevokedNotification",
  MCREAL_POST_COMMENTED: "gg.doofie.networking.model.notifications.notification.McRealPostCommentedNotification",
  MCREAL_COMMENT_COMMENTED: "gg.doofie.networking.model.notifications.notification.McRealCommentCommentedNotification",
  MCREAL_POSTED: "gg.doofie.networking.model.notifications.notification.McRealPostedNotification",
  MCREAL_MENTIONED_IN_POST: "gg.doofie.networking.model.notifications.notification.McRealMentionedInPostNotification",
  MCREAL_MENTIONED_IN_COMMENT: "gg.doofie.networking.model.notifications.notification.McRealMentionedInCommentNotification",
} as const;
