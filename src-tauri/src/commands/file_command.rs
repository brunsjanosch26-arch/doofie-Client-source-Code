...
use crate::integrations::doofie_packs::NoriskModEntryDefinition;
...
#[tauri::command]
pub async fn get_icons_for_doofie_mods(
    ...
    for mod_entry in &mods {
        match path_utils::get_doofie_mod_cache_path(mod_entry, &minecraft_version, &loader) {
            Ok(path) => {
