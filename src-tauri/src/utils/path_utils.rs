...
use crate::integrations::doofie_packs::{get_doofie_pack_mod_filename, NoriskModEntryDefinition};
...
// Konstante aus dem mod_downloader/doofie_pack_downloader übernehmen
...
pub fn get_doofie_mod_cache_path(
    ...
    let filename =
        get_doofie_pack_mod_filename(&mod_entry.source, &compatibility_target, &mod_entry.id)?;
