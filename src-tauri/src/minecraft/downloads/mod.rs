...
pub mod doofie_assets_download;
pub mod doofie_pack_downloader;
...
pub use doofie_assets_download::{client_managed_assets, NoriskClientAssetsDownloadService};
pub use doofie_pack_downloader::NoriskPackDownloadService;
