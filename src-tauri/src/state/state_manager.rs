...
use crate::state::doofie_packs_state::{default_doofie_packs_path, NoriskPackManager};
use crate::state::doofie_versions_state::{default_doofie_versions_path, NoriskVersionManager};
...
pub struct State {
    ...
    pub doofie_pack_manager: NoriskPackManager,
    pub doofie_version_manager: NoriskVersionManager,
    ...
    pub async fn init(app: Arc<tauri::AppHandle>) -> Result<()> {
        let initial_state_arc = LAUNCHER_STATE
            .get_or_try_init(|| async {
                ...
                let doofie_pack_manager = NoriskPackManager::new(default_doofie_packs_path())?;
                let doofie_version_manager = NoriskVersionManager::new(default_doofie_versions_path())?;
